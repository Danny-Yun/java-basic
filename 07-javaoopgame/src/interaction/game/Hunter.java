...
//	<------------------------------------------------->
	...
	public void setHunterHp(int hp) {
		this.hp = hp;
	}	
	public int getHunterAtt() {
		return att;
	}
	public int getHunterDef() {
		return def;
	}
...
//	<------------------------------------------------->
	...
	public void huntVampire (Vampire v) {
		...
		System.out.println("- 헌터가 뱀파이어 사냥을 시작합니다.");
		System.out.println();

		v.setVampireHp(v.getVampireHp() - (this.att - v.getVampireDef()) );
		System.out.println("- 헌터가 공격에 성공하였습니다.");
		System.out.println();
		System.out.println("--------------------------------");
    	System.out.println();
		...
		if (v.getVampireHp() > 0)  {
			...
			System.out.println("- 헌터가 뱀파이어를 물리쳤습니다!");
			this.mana += 10;
			this.exp += 20;
		...
		public void huntWerewolf (Werewolf w) {
			...
			System.out.println("- 헌터가 늑대인간 사냥을 시작합니다.");
			System.out.println();
			...
			if (w.getWerewolfHp() > 0)  {
				...
				System.out.println("- 헌터가 늑대인간을 물리쳤습니다!");
				this.mana += 10;
				this.exp += 20;
				System.out.println("- 경험치를 20 획득했습니다.");
				System.out.println("- 마나를 10 획득했습니다.");
			...
			public void huntOak (Oak o) {
				...
				System.out.println("- 헌터가 오크 사냥을 시작합니다.");
				System.out.println();
				...
				if (o.getOakHp() > 0)  {
					...
					System.out.println("- 헌터가 오크를 물리쳤습니다!");
					this.mana += 10;
					this.exp += 20;
					System.out.println("- 경험치를 20 획득했습니다.");
					System.out.println("- 마나를 10 획득했습니다.");

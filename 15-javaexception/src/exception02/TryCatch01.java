...
public class TryCatch01 {
	...
	public static void main(String[] args) {
		// try ~ catch 구문은 크게 예외로 발생할 수 있는 구문을 적는 try블록과, 예외 발생시 처리할 catch블록으로 나뉜다.
		...
		try {
			// 예외가 발생할 구문을 적는 블록. try블록은 반드시 하단에 catch블록이 추가로 작성되어야 한다.
			...
			// 모든 실행구문이 끝나고 실행할 코드는 finally블록 내부에 작성합니다.
